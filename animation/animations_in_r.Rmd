---
title: "Creating animations in R"
...
Before, we create a video, let's make sure we have our animation looking the way we really want. First, we could plot each point individually:
...
}, ani.width = 600, ani.height=600, img.name = "windowed_data", imgdir = "windowed_data", htmlfile = "index_window.html")
```
